  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        onChange={onChange}
        onBlur={onBlur}
        className={`w-full p-3 border border-background-300 rounded-lg text-text-900 focus:outline-none focus:ring-2 focus:ring-accent-500 placeholder-transparent dark:bg-background-200 text-xs md:text-[14px]
          ${Icon ? "pl-10" : ""} 
